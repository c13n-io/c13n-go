...
var file_rpc_services_rpc_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x32, 0xa8, 0x05,
	...
	0x37, 0x0a, 0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0xbe, 0x02, 0x0a, 0x0e, 0x50, 0x61, 0x79,
	...
	0x76, 0x6f, 0x69, 0x63, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x29, 0x5a, 0x27, 0x67, 0x69, 0x74,
...
var file_rpc_services_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
...
var file_rpc_services_rpc_proto_depIdxs = []int32{
	...
	70, // 8: services.Message.sent_timestamp:type_name -> google.protobuf.Timestamp
	70, // 9: services.Message.received_timestamp:type_name -> google.protobuf.Timestamp
	...
	70, // 31: services.Payment.created_timestamp:type_name -> google.protobuf.Timestamp
	70, // 32: services.Payment.resolved_timestamp:type_name -> google.protobuf.Timestamp
	...
	70, // 36: services.PaymentHTLC.attempt_timestamp:type_name -> google.protobuf.Timestamp
	70, // 37: services.PaymentHTLC.resolve_timestamp:type_name -> google.protobuf.Timestamp
	1,  // 38: services.PaymentHTLC.state:type_name -> services.HTLCState
	70, // 39: services.Invoice.created_timestamp:type_name -> google.protobuf.Timestamp
	70, // 40: services.Invoice.settled_timestamp:type_name -> google.protobuf.Timestamp
	...
	70, // 46: services.InvoiceHTLC.accept_timestamp:type_name -> google.protobuf.Timestamp
	70, // 47: services.InvoiceHTLC.resolve_timestamp:type_name -> google.protobuf.Timestamp
	...
	6,  // 74: services.NodeInfoService.GetVersion:output_type -> services.Version
	10, // 75: services.NodeInfoService.GetSelfInfo:output_type -> services.SelfInfoResponse
	12, // 76: services.NodeInfoService.GetSelfBalance:output_type -> services.SelfBalanceResponse
	16, // 77: services.NodeInfoService.GetNodes:output_type -> services.NodeInfoResponse
	16, // 78: services.NodeInfoService.SearchNodeByAddress:output_type -> services.NodeInfoResponse
	16, // 79: services.NodeInfoService.SearchNodeByAlias:output_type -> services.NodeInfoResponse
	18, // 80: services.NodeInfoService.ConnectNode:output_type -> services.ConnectNodeResponse
	20, // 81: services.ChannelService.OpenChannel:output_type -> services.OpenChannelResponse
	23, // 82: services.ContactService.GetContacts:output_type -> services.GetContactsResponse
	25, // 83: services.ContactService.AddContact:output_type -> services.AddContactResponse
	28, // 84: services.ContactService.RemoveContactByID:output_type -> services.RemoveContactResponse
	28, // 85: services.ContactService.RemoveContactByAddress:output_type -> services.RemoveContactResponse
	35, // 86: services.MessageService.EstimateMessage:output_type -> services.EstimateMessageResponse
	37, // 87: services.MessageService.SendMessage:output_type -> services.SendMessageResponse
	39, // 88: services.MessageService.SubscribeMessages:output_type -> services.SubscribeMessageResponse
	43, // 89: services.DiscussionService.GetDiscussions:output_type -> services.GetDiscussionsResponse
	45, // 90: services.DiscussionService.GetDiscussionHistoryByID:output_type -> services.GetDiscussionHistoryResponse
	47, // 91: services.DiscussionService.GetDiscussionStatistics:output_type -> services.GetDiscussionStatisticsResponse
	49, // 92: services.DiscussionService.AddDiscussion:output_type -> services.AddDiscussionResponse
	51, // 93: services.DiscussionService.UpdateDiscussionLastRead:output_type -> services.UpdateDiscussionResponse
	53, // 94: services.DiscussionService.RemoveDiscussion:output_type -> services.RemoveDiscussionResponse
	55, // 95: services.DiscussionService.Send:output_type -> services.SendResponse
	57, // 96: services.PaymentService.CreateInvoice:output_type -> services.CreateInvoiceResponse
	59, // 97: services.PaymentService.LookupInvoice:output_type -> services.LookupInvoiceResponse
	62, // 98: services.PaymentService.Pay:output_type -> services.PayResponse
	65, // 99: services.PaymentService.SubscribeInvoices:output_type -> services.Invoice
